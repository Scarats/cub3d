...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/22 12:19:15 by chboegne          #+#    #+#             */
/*   Updated: 2026/01/22 12:19:16 by chboegne         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Only use for testing or drawing the minimap,
// it gives the direction point from the position the angle and the length.
// Currently used to draw a line for testing.
void	set_dir_from_pos(t_dpoint *direction, t_dpoint *position, double angle,
		double length)
{
	double	rad;
	double	dx;
